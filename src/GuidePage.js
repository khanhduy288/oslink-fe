...
const GuidePage = () => {
  ...
  return (
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "20px", boxSizing: "border-box" }}>
      <h1 style={{ textAlign: "center", marginBottom: "40px" }}>Hướng dẫn các bước</h1>

      {/* B1 → B7: grid 3 cột, title trên ảnh */}
      <div
        style={{
          display: "grid",
      ...
      {/* B8 → B10: layout tách biệt, title + description dưới ảnh */}
      <h2 style={{ marginBottom: "20px" }}>Ảnh minh họa cuối</h2>
      <div
        style={{
          display: "grid",
          gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))",
      ...
      {/* Video cuối: 2 video 1 hàng */}
      <h2 style={{ marginBottom: "20px" }}>Video hướng dẫn</h2>
      <div
        style={{
          display: "grid",
